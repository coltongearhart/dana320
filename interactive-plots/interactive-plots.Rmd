...
![](images/slopegraph.png){width=50%}

<!-- NOTE: works in RStudio but not in learnr for some reason -->
...
<!-- NOTE: add subplot, then customize, subplot adds interactivity by default, then make shared data -->
