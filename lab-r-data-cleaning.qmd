...
This problem applies the ideas from the notes in @sec-notes-reshaping-and-combining-data, where we learned to restructure datasets, and also uses functions from **dplyr** functions from @sec-data-transformations.
