...
FILE: [hw-visualizations-STARTER.qmd](https://github.com/coltongearhart/dana320/blob/main/r/hw-visualizations-STARTER.qmd)

What will be looked at for grading: Correct code, output and sufficient write-ups where indicated.

## Overview

These problems apply the idea from the notes @sec-notes-visualizations, where we learned how to create plots using in R using **ggplot2**.
