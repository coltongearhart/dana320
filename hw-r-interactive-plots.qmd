...
FILE: [hw-interactive-plots-STARTER.qmd](https://github.com/coltongearhart/dana320/blob/main/r/hw-interactive-plots-STARTER.qmd)

What will be looked at for grading: Correct code, output and sufficient write-ups where indicated.

## Overview

These problems apply the idea from the notes in @sec-interactive-plots, where we learned how to create interactive plots in R using **plotly**.
